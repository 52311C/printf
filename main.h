...
int print_octal(va_list types, char buffer[], int flags, int width,
		int precisioin, int size);
int print_hexadecimal(va_list types, char buffer[], int flags, int width,
		int precision, int size);
int print_hexa_uupper(va_list, char buffer[], int flags, int width,
		int precision, int size);
...
int print_pointer(va_list tyes, char buffer[], int flags, int width,
		int precision, int size);
...
int write_num(int ind, char bff[], int lfags, int width, int precision,
